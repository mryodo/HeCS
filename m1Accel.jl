...
AppleAccelerate.@replaceBase ceil floor trunc round exp exp2 expm1 log log1p log2 log10 sin cos cospi tan asin acos atan cis sinh cosh tanh asinh acosh atanh sqrt copysign exponent abs rem
