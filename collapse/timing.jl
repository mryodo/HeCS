...
function repeatTries(N, add, rep)
      ...
      for repIt in 1 : rep
            ...
            timePeriod = @elapsed begin
                  fl, Σ1, Τ1, edge2Trig, trig2Edge, Ls, Free = greedyCollapseShort( edge2Trig, trig2Edge, vec(1:Δ), edges2 )
            end
            ...
            timePeriod2 = @elapsed begin
                  ...
                  while ind <= Δ
                        ...
                        if perm[ind] in leftovers
                              ...
                              #tmpSub = deepcopy( sub )
                              #tmpSubEdg2Trigs = subEdg2Trigs
                              #tmpSubTrig2Edg = subTrig2Edg
                              #tmpSub = sub
      ...
      return κ_original, κ_precon, κ_ldl, it_original, it_precon, it_ldl, m_sizes, Δ_sizes, times
end
